    ...
    pub fn draw<W: Write>(&self, writer: &mut W) -> io::Result<()> {
        ...
        let sections = vec![
            ...
            ("PYTHON REPL MODE", vec![
                ("Ctrl+E / Ctrl+Enter / F5", "Execute cell/code"),
            ...
            ("SNOWFLAKE REPL MODE", vec![
                ("Ctrl+E / Ctrl+Enter / F5", "Execute statement (cells split on semicolons)"),
                ...
                ("F8", "Open results in a new sage session (first 10k rows)"),
                ("Ctrl+L", "Clear output pane"),
                ("Ctrl+O", "Toggle output pane visibility"),
                ("Esc", "Toggle output pane focus"),
                ("Alt+Up / Alt+Down", "Resize output pane"),
            ...
            ("SHELL REPL MODE", vec![
                ("Ctrl+E / Ctrl+Enter / F5", "Execute cell/script (state persists between cells)"),
                ("Ctrl+Backspace", "Cancel execution (resets shell session)"),
                ("Ctrl+K", "Select shell (bash/zsh/sh)"),
                ("Ctrl+L", "Clear output pane"),
                ("Ctrl+O", "Toggle output pane visibility"),
                ("Esc", "Toggle output pane focus"),
                ("Alt+Up / Alt+Down", "Resize output pane"),
